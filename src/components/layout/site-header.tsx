...
export function SiteHeader() {
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-50 bg-transparent px-4 pt-4 md:px-8 md:pt-6">
      <header className="border-cream/40 bg-bone/65 shadow-nav pointer-events-auto mx-auto flex max-w-6xl min-h-14 items-center justify-between rounded-full border px-8 py-4 backdrop-blur-md md:min-h-16 md:px-10 md:py-5">
        <a
          href="/"
